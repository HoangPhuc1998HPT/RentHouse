...
from RentalManagementApplication.frontend.views.Landlord.LandlordListInvoices import ListInvoices
...
class LandlordController:
    ...
    def go_to_home_page(view, id_lanlord):
        ...
        from RentalManagementApplication.frontend.views.Landlord.LandlordHome import LandlordHome
    ...
    def go_to_room_list(view, id_lanlord):
        ...
        from RentalManagementApplication.frontend.views.Landlord.LandlordRoomList import RoomList
    ...
    def go_to_LanlordFindNewTenant(view, id_lanlord):
        from RentalManagementApplication.frontend.views.Landlord.LandlordFindNewTenant import FindNewTenant
    ...
    def go_to_create_new_room(view, id_lanlord):
        from RentalManagementApplication.frontend.views.Landlord.LandlordCreateNewRoom import CreateNewRoom
